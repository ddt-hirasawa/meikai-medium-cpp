...
enum Func_select {Integration ,Addition};	//enum型で 関数名に数字を与えます
...
int main()
{
	...
	//List3C-1 に準じます
	//static_castで変換し関数配列を選択します
	switch (static_cast<Func_select>(select)) {

	case Integration :

		//関数配列 0番目を引数として呼び出し乗算表を出します
		output(func_array[0]);
